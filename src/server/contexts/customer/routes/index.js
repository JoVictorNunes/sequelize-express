...
} = require("../controllers/CreateCustomerController");
const {
  GetAllCustomersController,
} = require("../controllers/GetAllCustomersController");
const {
  GetCustomerController,
} = require("../controllers/GetCustomerController");
const {
  UpdateCustomerController,
} = require("../controllers/UpdateCustomerController");
const {
